var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(circle, "cx", circle_cx_value = /*$xScale*/ ctx[2](/*$x*/ ctx[3](/*d*/ ctx[11])));
    			attr(circle, "cy", circle_cy_value = /*$yScale*/ ctx[4](/*$y*/ ctx[5](/*d*/ ctx[11])));
    			attr(circle, "r", /*r*/ ctx[0]);
    		},
    		m(target, anchor) {
    			insert(target, circle, anchor);
    		},
    		p(ctx, dirty) {
    			if (dirty & /*$xScale, $x, $data*/ 14 && circle_cx_value !== (circle_cx_value = /*$xScale*/ ctx[2](/*$x*/ ctx[3](/*d*/ ctx[11])))) {
    				attr(circle, "cx", circle_cx_value);
    			}

    			if (dirty & /*$yScale, $y, $data*/ 50 && circle_cy_value !== (circle_cy_value = /*$yScale*/ ctx[4](/*$y*/ ctx[5](/*d*/ ctx[11])))) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*$xScale, $x, $data, $yScale, $y, r*/ 63) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, x, value => $$invalidate(3, $x = value));
    	component_subscribe($$self, xScale, value => $$invalidate(2, $xScale = value));
    	component_subscribe($$self, y, value => $$invalidate(5, $y = value));
    	...
    	return [r, $data, $xScale, $x, $yScale, $y, data, x, xScale, y, yScale];
    }

    class Scatter extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { r: 0 });
    	}
    }
    ...
    function create_if_block(ctx) {
    	...
    	const layercake = new LayerCake({
    			props: {
    				containerWidth: /*chartW*/ ctx[0],
    				containerHeight: /*chartH*/ ctx[1],
    				data: /*data*/ ctx[4],
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*chartW*/ 1) layercake_changes.containerWidth = /*chartW*/ ctx[0];
    			if (dirty & /*chartH*/ 2) layercake_changes.containerHeight = /*chartH*/ ctx[1];
    ...
    // (33:4) <LayerCake       containerWidth="{chartW}"       containerHeight="{chartH}"       {data}       {padding}       x="x"       y="y">
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			set_style(figure, "height", /*chartH*/ ctx[1] + "px");
    			attr(figure, "class", "svelte-fe5df0");
    			add_render_callback(() => /*figure_elementresize_handler*/ ctx[6].call(figure));
    			toggle_class(figure, "visible", /*visible*/ ctx[2]);
    		},
    		m(target, anchor) {
    			insert(target, figure, anchor);
    			if (if_block) if_block.m(figure, null);
    			figure_resize_listener = add_resize_listener(figure, /*figure_elementresize_handler*/ ctx[6].bind(figure));
    			current = true;
    		},
    		p(ctx, [dirty]) {
    			if (/*visible*/ ctx[2]) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*chartW*/ 1) {
    			// responsive chart, don't render until dimensions are ready
    			 $$invalidate(1, chartH = Math.floor(chartW / RATIO));
    		}

    		if ($$self.$$.dirty & /*chartW*/ 1) {
    			 $$invalidate(2, visible = !!chartW);
    		}
    	};

    	return [chartW, chartH, visible, padding, data, pad, figure_elementresize_handler];
    }
